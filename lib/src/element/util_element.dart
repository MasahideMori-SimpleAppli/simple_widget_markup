...
class UtilElement {
  ...
  static SpWMLElement create(
    ...
    EnumSpWMLElementType eType = EXTEnumSpWMLElementType.fromStr(
      type,
      lineStart,
      lineEnd,
      info,
    ...
    late SpWMLElement r;
    final SpWMLParamsWrapper spwmlParams = SpWMLParamsWrapper(
      SpWMLParams(text),
    );
    // v2
    ...
    // v3
      ...
      r = VLineElement(
        ...
        style,
        info,
        VLineParamsWrapper(VLineParams()),
      );
      ...
      r = SwitchBtnElement(
        ...
        style,
        info,
        SwitchBtnParamsWrapper(SwitchBtnParams()),
      );
      ...
      r = SliderElement(
        ...
        style,
        info,
        SliderParamsWrapper(SliderParams()),
      );
